        ...
        <div className="container">
          ...
          <div className="source-grid">
            {[
              ...
              { name: 'CNB', color: '#FF6600', desc: t.about.srcCnbDesc, icon: <Image src="https://cos.jsdmirror.com/images/2021/09/10/cnb.png" alt="CNB" width={32} height={32} style={{ objectFit: 'contain' }} unoptimized /> },
